...
app.markups = {
    ...
    commentMarkup: function(comment) {
		return `<li class="single_comment_area"><div class="comment-wrapper d-flex">
                    <div class="comment-author"><span>${comment.commentName[0]}<span></div>
                    <div class="comment-content">\
                        <div class="d-flex align-items-center justify-content-between">
                        <h5>${comment.commentName}</h5><span class="comment-date">
                            ${comment.commentDate.split('-')[1]}/` +
                            `${comment.commentDate.split(':')[0].split('-')[2].split('T')[0]}/` +
        ...
        return `
            <div class="single-latest-post d-flex align-items-center">
                ...
                <div class="post-content">
                    ...
                    <a href="/blog/post_number=${post.postId}" class="post-date">${post.postDate}</a>
                </div>
            </div>`
    },
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <div class="product-info mt-15 text-center">
                        <a href="http://127.0.0.1:2000/nubia/products/product_number=${prod.prodId}">
                            <p>${prod.prodName}</p>
                        </a>
